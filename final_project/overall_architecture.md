...
Finally the Backend component needs to fetch information from the unreliable Technicians API. For that the Cloud Platform Team provides a Technicians Manager App service with a Technicians Cache Table Storage. The Technicians API responces are this way cached and the backend fetches from the Technicians Manager component.
